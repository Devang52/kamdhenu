...
function Subscription() {
    ...
    const GET = async () => {
        var config = {
            ...
            url: (token, `${api}/get_cat`),
            headers: {
                Authorization: token,
            },
        };
        try {
            const subcat = await axios(config);
            setCustomer(subcat.data.data);
            setmainCat(subcat.data.data);
        } catch (error) {
            console.error(error);
            setLoader(true)
        }
    ...
    const handleDelete = async (Id) => {
        ...
        await DELETE(token, url, deleteData, alert);
        GET()
    };
                                            ...
                                            {currentItems.length === 0 ? (
                                                ...
                                                currentItems.map((dataa, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            {dataa.title.charAt(0).toUpperCase() +
                                                                dataa.title.slice(1)}
                                                        </td>
                                                        <td>
                                            ...
                                            <tr>
                                                ...
                                                {/* <td>
                                                    <div className="table-actions d-flex">
                                                        ...
                                                        <div className="delete-table delll">
                                                            <img src="assets/img/icons/delete.svg" alt="svg" />
                                                        </div>
                                                    </div>
                                                </td> */}
